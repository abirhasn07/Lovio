...
const HeroBanner = () => {
	return (
		<div className="max-w-[1920px] bg-primary pb-8 lg:py-12 z-40 ">
			<div className="flex w-full mx-auto relative justify-center lg:w-[90%] isolate">
				<img
					...
					className="-z-10 w-[50%] scale-[.9] absolute object-cover rotate-6 right-[5%] bottom-0 h-[80vh]"
					loading="lazy"
				/>
				...
				<img
					...
					alt="wedding photoshoots"
					className="w-[50%]  scale-105 h-[80vh] object-cover"
					loading="lazy"
				/>
				<img
					src={
					...
					alt="wedding photoshoots"
					className="-z-10  w-[50%] scale-[.9] -rotate-6 absolute object-cover left-[5%] bottom-0 h-[80vh]"
					id="img"
					loading="lazy"
				/>
			</div>
