		...
		<div className="max-w-[1440px] bg-primary pb-8 lg:py-12 ">
			<div className="flex w-full mx-auto relative justify-center lg:w-[90%]">
				<img
					...
					className="w-[50%] scale-[.9] absolute object-cover rotate-6 right-[5%] bottom-0"
					loading="lazy"
				/>
				...
				<img
					...
					alt="wedding photoshoots"
					className="w-[50%] scale-[.9] -rotate-6 z-0 absolute object-cover left-[5%] bottom-0"
					id="img"
					loading="lazy"
				/>
			</div>
